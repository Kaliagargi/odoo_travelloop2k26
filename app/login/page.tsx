      ...
      <div className="w-full max-w-4xl rounded-2xl overflow-hidden shadow-2xl flex min-h-[680px]">
        ...
        >
          ...
          <div className="relative z-10">
            <p className="text-white/50 text-xs tracking-[4px] uppercase mb-4">Start your journey</p>
            ...
            <p className="text-white/55 text-[15px] leading-[1.7] mb-10 max-w-[320px]">
              Book flights, hotels and experiences — all in one place. Travel smarter, live fuller.
            </p>

            <div className="flex gap-6">
              <div className="text-center">
                <p className="text-white text-[22px] font-bold m-0">2M+</p>
                <p className="text-white/45 text-xs mt-1">Travelers</p>
              </div>
              <div className="w-px bg-white/15" />
              <div className="text-center">
                <p className="text-white text-[22px] font-bold m-0">190+</p>
                <p className="text-white/45 text-xs mt-1">Countries</p>
              </div>
              <div className="w-px bg-white/15" />
              <div className="text-center">
                <p className="text-white text-[22px] font-bold m-0">4.9★</p>
                <p className="text-white/45 text-xs mt-1">Rating</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex-[0.9] bg-[#FAFAF8] flex flex-col justify-center px-12 py-14">
          ...
          <p className="text-[#888] text-xs tracking-[3px] uppercase mb-2">Welcome back</p>
          <h2 className="text-[#023047] text-[28px] font-bold mb-8">Sign in to continue</h2>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div className="text-right -mt-2">
              <Link href="/forgot-password" className="text-xs text-[#0077B6] no-underline hover:underline">
                Forgot password?
              </Link>
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3.5 bg-[#0077B6] text-white border-none rounded-[10px] text-[15px] font-semibold cursor-pointer tracking-[0.3px] hover:bg-[#005f8e] active:scale-[0.98] transition-all disabled:opacity-60 disabled:cursor-not-allowed"
            >
          ...
          {/* Register hint */}
          <div className="flex items-center gap-2 mt-5 px-4 py-3.5 bg-[#FFFBF0] rounded-[10px] border border-[#FFE5A0]">
            <div className="w-2 h-2 rounded-full bg-[#FFB703] shrink-0" />
            <p className="text-xs text-[#7A5C00] m-0">
              New to Traveloop?{" "}
              <Link href="/register" className="text-[#B8860B] font-semibold no-underline hover:underline">
